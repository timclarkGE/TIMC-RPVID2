...
class AnalogGaugeWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.debug1 = None
        self.debug2 = None
        self.scale_angle_start_value = 0
        ...
        #use this to create the gradient of the background
        self.scale_polygon_colors = []
        self.set_scale_polygon_colors([[0, Qt.red],
                                     [.15,Qt.yellow],
                                     [.25, Qt.green],
                                     [.35,Qt.yellow],
                                     [.5, Qt.red]])
    ...
    def set_enable_mirror(self, enable = True):
        self.mirror = enable
        if not self.use_timer_event:
            self.update()
...
if __name__ == '__main__':
    ...
    class mainclass():
        ...
        def __init__(self):
            ...
            self.my_gauge.widget.value_min = -25
            self.my_gauge.widget.value_max = 25
            self.my_gauge.widget.scala_main_count = 10
            ...
            # set Start Value
            self.my_gauge.widget.update_value(12)
            # self.my_gauge.widget.update_value(int(self.my_gauge.widget.value_max - abs(self.my_gauge.widget.value_min))/2)
            ...
            self.my_gauge.CB_Mirror.stateChanged.connect(self.set_enable_mirror)
        ...
        def set_enable_mirror(self):
            self.my_gauge.widget.set_enable_mirror(self.my_gauge.CB_Mirror.isChecked())
